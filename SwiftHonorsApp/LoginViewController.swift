...
class LoginViewController: UIViewController, FBSDKLoginButtonDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColorFromHex(rgbValue: 0x4099FF, alpha: 1);
    ...
    func fetchProfile() {
        ...
        FBSDKGraphRequest(graphPath: "me", parameters: parameters).start(completionHandler: { (connection, user, requestError) -> Void in
            ...
            /* userEmail = ((user as? [String : String])?["email"])!
            let firstName = (user as? [String : String])?["first_name"]
            let lastName = (user as? [String : String])?["last_name"] */
